...
<!--          <kevin-form ref="kevinForm" :open-env="currentEnv" :bolckFormParams="listParamsList" :form="form"-->
...
<!--      anchorInfo.tableData.forEach(itemBackInfo => {-->
<!--        itemBackInfo.itemNameCn = itemBackInfo.itemName;-->
<!--        itemBackInfo.methodCode = itemBackInfo.itemCode;-->
<!--        itemBackInfo.childMethodName = itemBackInfo.subname-->
<!--      });-->
<!--      this.$nextTick(() => {-->
<!--        this.$refs.selectItem.initItemList(data.id, anchorInfo.tableData, [])-->
<!--      })-->
...
<!--      // this.$store.commit('set_detectType', data.id)-->
<!--      // let anchorInfo = EntrustThis.getNode(EntrustThis.listParamsList, 'formList', 'anchorPoint', 'detectItemTable');-->
<!--      // let selectedItems = JSON.parse(JSON.stringify(anchorInfo.tableData));-->
<!--      // EntrustThis.showselectItem = true;-->
<!--      // EntrustThis.$nextTick(() => {-->
<!--      //     EntrustThis.$refs.selectItem.initItemList(this.$store.state.BeiYuan.detectType, selectedItems);-->
<!--      // })-->
<!--    },-->
<!--    // 添加检测项目回调-->
...
<!--      let anchorInfo = this.getNode(this.listParamsList, 'formList', 'anchorPoint', 'detectItemTable')-->
...
<!--          this.form.detectedDeptName = res.data.customerName-->
<!--          this.form.customerName = res.data.customerName-->
<!--          this.form.extData.inspectionPersonal = user.nickName-->
<!--          this.form.detectedDeptId = user.customerId-->
<!--          this.form.extData.detectedDeptId = user.userId-->
<!--          this.form.extData.contactSendId = user.userId-->
<!--          this.form.customerId = user.customerId-->
<!--          this.form.contactId = user.userId-->
<!--          this.form.extData.inspectionPhone = user.phone-->
<!--          this.form.deptCreditCode = res.data.uscc-->
