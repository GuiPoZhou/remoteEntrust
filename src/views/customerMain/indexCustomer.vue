...
<!--  <div style="padding: 0">-->
<!--    <div class="app-index">-->
<!--      <el-row type="flex" class="row-bg" :gutter="10" justify="space-around">-->
<!--        <el-col :span="6" :xs="24" :sm="24" :md="24" :lg="6" class="cm-center-left">-->
<!--          <indexleft-->
...
<!--          />-->
<!--        </el-col>-->
<!--        <el-col :span="6" :xs="24" :sm="24" :md="24" :lg="6"  class="cm-center-right">-->
...
<!--// index模板布局-->
<!--import indexleft from './indexCustomerComponents/indexleft'-->
<!--import indexCenter from './indexCustomerComponents/indexCenter'-->
<!--import indexRight from './indexCustomerComponents/indexRight'-->
<!--import indexEvaluate from './indexCustomerComponents/indexEvaluate'-->
<!--export default {-->
<!--  name: "Index",-->
<!--  components: {-->
<!--    indexCustomerNav,-->
