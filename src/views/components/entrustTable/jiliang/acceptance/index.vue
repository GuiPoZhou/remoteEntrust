        ...
        <BoMain>
          <template slot="botabs">
            <el-tabs v-model="activeName" @tab-click="handleClick">
              <el-tab-pane label="待验收" name="0"></el-tab-pane>
              <el-tab-pane label="已验收" name="1"></el-tab-pane>
            </el-tabs>
          </template>
...
<script setup>
import acceptDialog from './dialog/acceptDialog.vue'
...
const check = (row) => {
  showLog.value = true
  nextTick(() => {
    vm.$refs.showLogRef.init('show', row)
  })
}
</script>
<style scoped>
